...
(define (value-of-simple-exp exp env)
  (cases cps-simple-exp exp
    [atom-exp->simple (atom1)
                      (value-of-atom-exp atom1 env)]
    [cps-diff-exp (atom1 atom2)
                  (num-val (- (expval->num (value-of-atom-exp atom1 env))
                              (expval->num (value-of-atom-exp atom2 env))))]
    [cps-zero?-exp (atom1)
...
(define (value-of-atom-exp exp env)
  (cases cps-atom-exp exp
    [cps-const-exp (num)
                   (num-val num)]
    [cps-var-exp (var)
                 (apply-env env var)]
