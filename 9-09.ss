...
(define (class-field-ref obj c-name f-name)
  (cases object obj
    [an-object (cn fs)
               (let ([loc (location f-name (class->field-names (lookup-class c-name)))])
                (if loc
...
(define (value-of exp env)
  (cases expression exp
    ...
    [superfieldref-exp (f-name)
                       (deref (class-field-ref (apply-env env '%self)
                                               (apply-env env '%super)
                                               f-name))]
    [superfieldset-exp (f-name exp1)
                       (setref! (class-field-ref (apply-env env '%self)
                                                 (apply-env env '%super)
                                                 f-name)
                                (value-of exp1 env))]
    ))
...
class c1 extends object
 ...
 method sety(v) set y = v
 method setz(v) set z = v
 method setw(v) set w = v
class c2 extends c1
 field x
 field y
 method initialize()
 ...
 method x1() superfieldref x
 method setx1(v) superfieldset x = v
 method y1() superfieldref y
 method sety1(v) superfieldset y = v
class c3 extends c2
 field y
 field z
 method initialize()
 ...
 method y2() superfieldref y
 method sety2(v) superfieldset y = v
 method z2() superfieldref z
 method setz2(v) superfieldset z = v
 method x() x
 method y() y
 method z() z
 method w() w
