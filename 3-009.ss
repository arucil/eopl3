...
(define (value-of exp env)
  (cases expression exp
    ...
    [cons-exp (exp1 exp2) (cons-val (value-of exp1 env) (value-of exp2 env))]
    [car-exp (exp) (car (expval->cons (value-of exp env)))]
    [cdr-exp (exp) (cdr (expval->cons (value-of exp env)))]
    [null?-exp (exp) (bool-val (expval-null? (value-of exp env)))]
